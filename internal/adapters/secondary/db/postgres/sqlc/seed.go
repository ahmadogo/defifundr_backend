...
func createSampleUsers(ctx context.Context, q *Queries) (map[string]uuid.UUID, error) {
	...
	employerParams := []CreateUserParams{
		{
			...
			ResidentialCountry:  pgtype.Text{String: "United States", Valid: true},
		...
		},
		{
			...
			LastName:            "Johnson",
			Nationality:         "Canada",
			ResidentialCountry:  pgtype.Text{String: "Canada", Valid: true},
	...
	employeeParams := []CreateUserParams{
		...
		},
		{
			...
			ResidentialCountry:  pgtype.Text{String: "United Kingdom", Valid: true},
		...
		},
		{
			...
			LastName:            "Rodriguez",
			Nationality:         "Spain",
			ResidentialCountry:  pgtype.Text{String: "Spain", Valid: true},
	...
	freelancerParams := []CreateUserParams{
		{
			...
			ResidentialCountry:  pgtype.Text{String: "Singapore", Valid: true},
		...
		},
		{
			...
			ResidentialCountry:  pgtype.Text{String: "South Korea", Valid: true},
