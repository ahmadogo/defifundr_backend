...
contract CrowdFunding {
    ...
    function getCampaignDonationsCount(uint256 _campaignId) public view returns (uint256) {}

    function getCampaignDonatorsCount(uint256 _campaignId) public view returns (uint256) {}
    ...
    function getCampaignsByType(string memory _campaignType) public view returns (Campaign[] memory) {}
}
